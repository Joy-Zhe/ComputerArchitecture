...
#
# Script generated by Vivado on Fri Dec 22 11:12:49 +0800 2023
...
# script info
echo -e "multiplier.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_10 -L xbip_pipe_v3_0_6 -L xbip_bram18k_v3_0_6 -L mult_gen_v12_0_18 -L xil_defaultlib -L secureip -L xpm --snapshot multiplier xil_defaultlib.multiplier -log elaborate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xbip_utils_v3_0_10 xbip_pipe_v3_0_6 xbip_bram18k_v3_0_6)
