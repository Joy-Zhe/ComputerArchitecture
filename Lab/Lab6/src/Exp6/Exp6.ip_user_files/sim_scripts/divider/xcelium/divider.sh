...
#
# Script generated by Vivado on Fri Dec 29 15:06:34 +0800 2023
...
#
# Usage        : divider.sh
#                divider.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                divider.sh [-reset_run]
#                divider.sh [-reset_log]
#                divider.sh [-help]
#
...
#                script (type 'divider.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_10 -libname axi_utils_v2_0_6 -libname xbip_pipe_v3_0_6 -libname xbip_dsp48_wrapper_v3_0_4 -libname xbip_dsp48_addsub_v3_0_6 -libname xbip_bram18k_v3_0_6 -libname mult_gen_v12_0_18 -libname floating_point_v7_0_20 -libname xbip_dsp48_mult_v3_0_6 -libname xbip_dsp48_multadd_v3_0_6 -libname div_gen_v5_1_19 -libname xil_defaultlib -libname secureip"
...
# script info
echo -e "divider.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./divider.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.divider
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.divider -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log divider_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: divider.sh [-step]\n\
Usage: divider.sh [-lib_map_path]\n\
Usage: divider.sh [-reset_run]\n\
Usage: divider.sh [-reset_log]\n\
Usage: divider.sh [-keep_index]\n\
